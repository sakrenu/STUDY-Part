...
const TalkToNotes = () => {
    ...
    useEffect(() => {
        ...
        const clearVectorStores = async () => {
            try {
                ...
                const response = await fetch('http://20.193.248.159:8000/api/rag/clear_vector_store', {
                    method: 'POST',
                    headers: {
    ...
    const handleFileUpload = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`http://20.193.248.159:8000${endpoint}`, {
                method: 'POST',
                body: formData,
            });
    ...
    const handleQuerySubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://20.193.248.159:8000/api/rag/query_notes', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleGeneralKnowledgeQuery = async (originalQuery) => {
        ...
        try {
            const response = await fetch('http://20.193.248.159:8000/api/rag/general_query', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
