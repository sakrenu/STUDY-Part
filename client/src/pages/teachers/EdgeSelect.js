...
const EdgeSelect = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await axios.post('http://20.193.248.159:8000/upload', formData);
  ...
  const handleRegionSelect = async () => {
    ...
    try {
      ...
      const cloudinaryResponse = await axios.post('http://20.193.248.159:8000/upload', formData, {
