...
def segment_image_for_label(image_path, bounding_box, model, region_index=0):
    """
    ...
    for idx, mask in enumerate(masks):
        ...
        # Use the region_index to select a color
        color = colors[region_index % len(colors)]  # Cycle through colors based on region_index
