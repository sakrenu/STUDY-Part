...
# # ):
# #     try:
# #         logger.info(f"Segmentation request for image_id: {image_id}")
# #         logger.info(f"Segmentation request with body: image_id={image_id}, box={box}, points={points}, labels={labels}")
# #         if not image_id:
# #             logger.error("Missing image_id")
...
#             raise HTTPException(status_code=422, detail="box must be a list of 4 floats")
