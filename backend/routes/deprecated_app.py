...
from deprecated_sam import segment_all_regions
...
# Create deprecated router
deprecated_router = APIRouter(prefix="/deprecated")

# Move deprecated routes to this router
@deprecated_router.post('/segment_quiz')
...
@deprecated_router.post('/segment_label')
...
@deprecated_router.post('/save_quiz')
...
@deprecated_router.get('/get_all_quizzes')
...
@deprecated_router.get('/get_quiz/{quiz_id}')
...
@deprecated_router.post('/track_completion')
...
@deprecated_router.post('/validate_placement')
...
@deprecated_router.post('/add_note')
...
@deprecated_router.delete('/delete-image')
...
@deprecated_router.post('/segment-all')
...
@deprecated_router.get('/get_lessons')
...
# Add upload route to deprecated router
@deprecated_router.post('/upload')
async def deprecated_upload(image: UploadFile = File(...)):
    try:
        if not image:
            raise HTTPException(status_code=400, detail="No image file")
